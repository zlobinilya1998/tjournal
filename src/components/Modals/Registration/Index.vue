<template>
  <div class="fixed inset-0 overlay" @click="closeModal">
    <div class="bg-white modal rounded-lg flex overflow-hidden transition" ref="modal">
      <div
        class="w-1/3"
        :style="{
          backgroundImage:
      ...
      <div class="w-2/3 p-10 pt-24">
        ...
        <div class="space-y-3 mt-5">
          <button
            class="p-2 shadow-md rounded-lg flex w-full text-center font-medium"
          >
            <svg
              width="24"
              height="24"
