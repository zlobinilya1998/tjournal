  ...
  <div class="flex space-x-6 items-start">
    <div class="w-2/3 rounded-lg flex justify-center items-center">
      <div v-if="comments.length > 0" class="w-full">
        <div v-for="comment in comments" :key="comment._id" class="p-5 bg-white rounded-lg mb-8">
      ...
      <div v-else class="w-full p-5 bg-white rounded-lg">Пользователь еще не оставил ни одного комментария</div>
    </div>
    <div class="w-1/3">
