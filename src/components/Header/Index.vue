<template>
  ...
  >
            ...
            <button class="flex">
              ...
              >
                <path
                  fill-rule="evenodd"
                  clip-rule="evenodd"
                  d="M20 4a1 1 0 011 1v6a4 4 0 01-4 4H6.414l3.293 3.293a1 1 0 01-1.414 1.414l-5-5a1 1 0 010-1.414l5-5a1 1 0 011.414 1.414L6.414 13H17a2 2 0 002-2V5a1 1 0 011-1z"
                ></path>
              </svg>
    ...
    <div v-if="user" class="hidden md:flex items-center">
      ...
      <img
        @click="profilePage"
        class="mr-2 rounded-lg w-10 h-10 object-cover cursor-pointer"
        :src="userAvatar"
      />
      <svg
        class="cursor-pointer hover:text-yellow-500 fill-current"
        height="7"
        width="10"
        viewBox="0 0 18 11"
        id="ui_arrow_down"
